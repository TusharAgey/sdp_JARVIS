...
public class SignUp extends AppCompatActivity implements TextToSpeech.OnInitListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText num2 = (EditText) findViewById(R.id.passNum2);

        Button buttonOne = (Button) findViewById(R.id.signupButton);
        buttonOne.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                if(num1.getText().toString().equals("") || num2.getText().toString().equals("") || etx.getText().toString().equals("")){
                    speakIt("Please enter every field");
                    return;
                }
                else{
                    db.addFlagPass(Integer.parseInt(num1.getText().toString()), Integer.parseInt(num2.getText().toString()));
